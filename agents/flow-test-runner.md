...
description: Executes test and typecheck commands for /flow pipeline and reports structured results. Called in Phase 4 (batch-scoped) and Phase 5 (full suite + typecheck). No code writing, no reasoning — pure command execution and result parsing.
